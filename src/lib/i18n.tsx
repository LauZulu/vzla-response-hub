...
const es: Dict = {
  ...
  "help.sub": "Canales verificados. Dona dinero, insumos o tu tiempo.",
  "help.money.title": "Donaciones monetarias",
  "help.money.intro": "Dona a organizaciones verificadas que emiten certificado de donación.",
  "help.money.a.name": "Cruz Roja Venezolana",
  "help.money.a.sub": "Sociedad Venezolana de la Cruz Roja | RIF: J-00235031-8",
  "help.money.a.details": "Banco Banesco\nBolívares (VES): 0134-0224-82-2243028658\nDólares (USD): 0134-1736-99-0001006051",
  "help.money.b.name": "Fundación Juntos Se Puede",
  "help.money.b.sub": "Taller de Aprendizaje para las Artes y el Pensamiento | NIT: 900.918.725-7",
  "help.money.b.details": "Banco de Occidente\nCuenta de Ahorros: 215-83676-8\nEmiten certificado de donación.",
  "help.money.c.name": "Dividendo Voluntario para la Comunidad",
  "help.money.c.sub": "Vía Banco Mercantil | Donaciones nacionales e internacionales",
  "help.money.c.details": "Pago móvil (Venezuela):\nBanco Mercantil / J-000579105 / (0412) 332-1367\n\nTransferencia nacional (Venezuela):\nBanco Mercantil\nTitular: Dividendo Voluntario para la Comunidad, A.C.\nCta. Corriente: 0105-0026-5410-2642-4518\nRIF: J-000579105\n\nCuenta en divisas (internacional):\nDividendo Voluntario para la Comunidad, A.C.\nBanco: Mercantil Banco, S.A.\nSWIFT: MPANPAPA\nNo. de cuenta: 300016658\nDirección: Torre de las Américas, Punta Pacífica, Ciudad de Panamá, Panamá",
  "help.money.c.note": "Mercantil realiza un aporte adicional para fortalecer cada donación.",
  "help.money.verify": "Verifica siempre las cuentas antes de transferir. Estas cuentas han sido confirmadas por las organizaciones.",
  "help.supplies.title": "Donación de insumos físicos",
  "help.supplies.intro": "La Fundación Juntos Se Puede recibe donaciones físicas en Bogotá.",
  "help.supplies.addressLabel": "Dirección:",
  "help.supplies.address": "Calle 104 #54-31, Suba, Bogotá",
  "help.supplies.needs": "Lo que más necesitan: agua embotellada, pastillas potabilizadoras, filtros de agua, enlatados (atún, sardinas, granos), barras energéticas, leche en polvo, alimentos para bebés, artículos de higiene, pañales para bebé y adulto, botiquines de primeros auxilios.",
  "help.people.title": "Canales humanitarios para buscar personas",
  "help.people.intro": "Si buscas a alguien o ya encontraste a alguien, repórtalo.",
  "help.people.row1": "Reportar o buscar desaparecidos (gratis, toma un minuto)",
  "help.people.cta": "Acceder",
  "help.people.row2": "Si ya sabes que alguien está bien, repórtalo también. Que su nombre dé tranquilidad, no angustia.",
  "help.people.row3": "Cruz Roja: servicio gratuito y confidencial para reconectar familias (Restablecimiento del Contacto Familiar). Escribe a @cruzrojave o a la Cruz Roja de tu país.",
  "help.disclaimer": "Información recopilada de fuentes verificadas por la comunidad. Esta plataforma no gestiona dinero directamente.",
...
const en: Dict = {
  ...
  "help.sub": "Verified channels. Donate money, supplies, or your time.",
  "help.money.title": "Monetary donations",
  "help.money.intro": "Donate to verified organizations that issue a donation certificate.",
  "help.money.a.name": "Venezuelan Red Cross",
  "help.money.a.sub": "Sociedad Venezolana de la Cruz Roja | RIF: J-00235031-8",
  "help.money.a.details": "Banco Banesco\nBolivars (VES): 0134-0224-82-2243028658\nDollars (USD): 0134-1736-99-0001006051",
  "help.money.b.name": "Fundación Juntos Se Puede",
  "help.money.b.sub": "Taller de Aprendizaje para las Artes y el Pensamiento | NIT: 900.918.725-7",
  "help.money.b.details": "Banco de Occidente\nSavings Account: 215-83676-8\nThey issue a donation certificate.",
  "help.money.c.name": "Dividendo Voluntario para la Comunidad",
  "help.money.c.sub": "Via Banco Mercantil | National and international donations",
  "help.money.c.details": "Mobile payment (Venezuela):\nBanco Mercantil / J-000579105 / (0412) 332-1367\n\nDomestic transfer (Venezuela):\nBanco Mercantil\nAccount holder: Dividendo Voluntario para la Comunidad, A.C.\nChecking account: 0105-0026-5410-2642-4518\nRIF: J-000579105\n\nForeign currency account (international):\nDividendo Voluntario para la Comunidad, A.C.\nBank: Mercantil Banco, S.A.\nSWIFT: MPANPAPA\nAccount number: 300016658\nAddress: Torre de las Américas, Punta Pacífica, Panama City, Panama",
  "help.money.c.note": "Mercantil contributes an additional amount to strengthen every donation.",
  "help.money.verify": "Always verify accounts before transferring. These accounts have been confirmed by the organizations.",
  "help.supplies.title": "Physical supply donations",
  "help.supplies.intro": "Fundación Juntos Se Puede receives physical donations in Bogotá.",
  "help.supplies.addressLabel": "Address:",
  "help.supplies.address": "Calle 104 #54-31, Suba, Bogotá",
  "help.supplies.needs": "Most needed: bottled water, water purification tablets, water filters, canned food (tuna, sardines, beans), energy bars, powdered milk, baby food, hygiene items, baby and adult diapers, first-aid kits.",
  "help.people.title": "Humanitarian channels to search for people",
  "help.people.intro": "If you are looking for someone, or have already found someone, report it.",
  "help.people.row1": "Report or search for missing people (free, takes a minute)",
  "help.people.cta": "Open",
  "help.people.row2": "If you already know someone is safe, report it too. Let their name bring peace, not anguish.",
  "help.people.row3": "Red Cross: free and confidential service to reconnect families (Restoring Family Links). Write to @cruzrojave or to your country's Red Cross.",
  "help.disclaimer": "Information gathered from sources verified by the community. This platform does not handle money directly.",
