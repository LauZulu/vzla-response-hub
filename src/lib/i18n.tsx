...
const es: Dict = {
  ...
  "quick.search.note": "La plataforma mas utilizada. 57.000+ reportes ciudadanos. Busca por nombre, reporta a alguien, marca como localizado.",
  "quick.search.sub": "Tambien: venezuelatebusca.com | venezuelareporta.org",
  "quick.shelter.label": "Necesito refugio",
  "quick.shelter.note": "Encuentra refugios, centros de acopio y voluntarios. Registra tu centro si estas recibiendo personas.",
  "quick.shelter.sub": "Tambien: acopios-refugios.vercel.app (mapa colaborativo)",
  "quick.damage.label": "Reportar danos",
  "quick.damage.note": "Sube fotos de tu edificio. Un ingeniero civil voluntario evalua el riesgo de habitabilidad. Gratis, sin registro.",
  "quick.damage.sub": "Tambien: terremotovenezuela.com (mapa de danos ciudadano)",
  "quick.donate.label": "Quiero donar",
  "quick.donate.note": "Donacion online directa. Pago seguro con tarjeta.",
  "quick.donate.sub": "Banesco duplica tu donacion para Cruz Roja: 0134-0008-37-0081096451. Ria Money Transfer: transferencias a Venezuela sin comision hasta julio 15.",
...
const en: Dict = {
  ...
  "quick.search.note": "The most used platform. 57,000+ citizen reports. Search by name, report someone, mark as located.",
  "quick.search.sub": "Also: venezuelatebusca.com | venezuelareporta.org",
  "quick.shelter.label": "I need shelter",
  "quick.shelter.note": "Find shelters, collection centers and volunteers. Register your center if you are receiving people.",
  "quick.shelter.sub": "Also: acopios-refugios.vercel.app (collaborative map)",
  "quick.damage.label": "Report damage",
  "quick.damage.note": "Upload photos of your building. A volunteer civil engineer evaluates habitability risk. Free, no registration.",
  "quick.damage.sub": "Also: terremotovenezuela.com (citizen damage map)",
  "quick.donate.label": "I want to donate",
  "quick.donate.note": "Direct online donation. Secure card payment.",
  "quick.donate.sub": "Banesco doubles your donation for Red Cross: 0134-0008-37-0081096451. Ria Money Transfer: fee-free transfers to Venezuela until July 15.",
